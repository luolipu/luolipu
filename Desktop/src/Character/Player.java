...
/**
 * This class is part of the "World of Zuul" application. "World of Zuul" is a very simple, text
 * based adventure game.
 *
 * <p>A player is a Character. It inherit from the Character Interface. It is used to create a
 * Player class. We have a name, a currentRoom and an inventory.
 *
...
public class Player implements Character {
  ...
  public void giveItem(String desc, String character) {
    ...
    if (this._currentRoom.getCharacter(character).getTotalWeight()
            + this._itemsInventory.get(desc).getWeight()
        > this._currentRoom.getCharacter(character).getMaxWeight()) {
  ...
  public void look() {
    for (String str : getCurrentRoom().getDetails()) AGame._out.println(str);
  }

  public void eat() {
    this._MAX_WEIGHT = _MAX_WEIGHT + 3;
    ;
    // 测试是否执行
    //		System.out.println(_MAX_WEIGHT);
